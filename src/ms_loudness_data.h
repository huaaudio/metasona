...
#ifndef METASONA_LOUDNESS_DATA_H
#define METASONA_LOUDNESS_DATA_H

static const double MS_FILTER_REFERENCE[3][6] =
{   {1, 2, 1, 1, -2, 1},
    {1, 0,-1, 1, -2, 1},
    {1,-2, 1, 1, -2, 1}
};

static const double MS_FILTER_DELTA[28][3][6] =
...
static const double MS_FILTER_GAIN[28][3] =
{   {4.30764e-011,1,1},
    {8.59340e-011,1,1},
    {1.71424e-010,1,1},
    {3.41944e-010,1,1},
